import { ACHIEVEMENT_REDACTOR_4_YEARS } from '../../constants';
...
export class Redactor4Years extends AchievementHandler {
    usersRepository: Repository<UserEntity>
    YEARS: number = 4 * TimesEnum.YEAR;

    constructor(
        protected readonly dataSource: DataSource,
    )
    {
        super(dataSource, ACHIEVEMENT_REDACTOR_4_YEARS)
    ...
    async condition() {
        ...
        let haveAchievements = await this.usersRepository.find({
            ...
            where: { 
                ...
                achievements: {
                    ...
                    achievement_data: {
                        id: ACHIEVEMENT_REDACTOR_4_YEARS.id
                    }
            }}
        })
        ...
        let dontHaveAchievements = await this.usersRepository.find({
            ...
            where: { 
                ...
                achievements: {
                    achievement_data: {
                        id: Not(ACHIEVEMENT_REDACTOR_4_YEARS.id)
                    }
                }
            }
        })
