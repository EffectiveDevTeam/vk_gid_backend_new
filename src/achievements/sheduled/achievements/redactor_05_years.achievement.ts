import { ACHIEVEMENT_REDACTOR_05_YEARS } from '../../constants';
...
export class Redactor05Years extends AchievementHandler {
    usersRepository: Repository<UserEntity>
    YEARS: number = 0.5 * TimesEnum.YEAR;

    constructor(
        protected readonly dataSource: DataSource,
    )
    {
        super(dataSource, ACHIEVEMENT_REDACTOR_05_YEARS)
    ...
    async condition() {
        ...
        let haveAchievements = await this.usersRepository.find({
            ...
            where: { 
                ...
                achievements: {
                    ...
                    achievement_data: {
                        id: ACHIEVEMENT_REDACTOR_05_YEARS.id
                    }
            }}
        })
        ...
        let dontHaveAchievements = await this.usersRepository.find({
            ...
            where: { 
                ...
                achievements: {
                    achievement_data: {
                        id: Not(ACHIEVEMENT_REDACTOR_05_YEARS.id)
                    }
                }
            }
        })
